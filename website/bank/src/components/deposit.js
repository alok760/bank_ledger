                        ...
                        <div className="card-header">
                            <div className="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                                ...
                                <ul role="tablist" className="nav bg-light nav-pills rounded nav-fill mb-3">
                                    <li className="nav-item"> <a data-toggle="pill" href="#card" className="nav-link active "> <i className="fas fa-credit-card"></i> Card Deposit </a> </li>
                                    <li className="nav-item"> <a data-toggle="pill" href="#cash" className="nav-link"> <i className="fas fa-university"></i> Cash Deposit </a> </li>
                                    <li className="nav-item"> <a data-toggle="pill" href="#paypal" className="nav-link "> <i className="fab fa-paypal"></i> Paypal </a> </li>
                                    <li className="nav-item"> <a data-toggle="pill" href="#net-banking" className="nav-link "> <i className="fas fa-mobile-alt"></i> Net Banking </a> </li>
                                </ul>
                            </div>

                            <div className="tab-content">

                                <div id="card" className="tab-pane fade show active pt-3">
                                ...
                                <div id="cash" className="tab-pane fade pt-3">
                                    <h6 className="pb-2">Select Bank Appointment Time for Cash/Cheque Deposit</h6>
